...
//! for Shift+Enter silently swallows the chord before pacer sees it.
//!
...
/// What a *console app* — pacer's own TUI, which reads `INPUT_RECORD`s
...
/// into pacer. `ESC CR` survives as Alt+Enter, which the TUI re-encodes
