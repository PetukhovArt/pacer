...
const MIGRATIONS: &[&str] = &[
    ...
    // agent-driven auto-title (`pacer rename` from inside the CLI);
...
impl Store {
    ...
    /// (`pacer rename` from inside the CLI). The flag is store-internal:
...
mod tests {
    ...
    fn unseen_follows_the_status_and_clears_on_seen() {
        ...
        // A Stop pacer never saw the prompt for is not a yellow → green.
    ...
    /// nothing is left pointing at a repo pacer no longer knows.
    #[test]
