...
//!
//! * **Host reachability.** pacer runs *inside* Terminal.app / Ghostty /
...
pub const ACTIONS: &[ActionSpec] = &[
    ...
    ActionSpec {
        ...
        id: "focus_left",
        label: "Focus left",
        hint: "Move focus one tile left, following the layout on screen and stepping over the terminal pane; a double tap at the leftmost tile jumps to the workspaces bar, like ⇧Tab",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["h", "left"],
    },
    ActionSpec {
        ...
        id: "focus_right",
        label: "Focus right",
        hint: "Move focus one tile right, following the layout on screen; a double tap beside the terminal pane jumps into it and takes input, like Tab",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["l", "right"],
    },
    ...
    ActionSpec {
        ...
        hint: "Re-tile: the focused panel goes left of its neighbour, or onto the left edge",
        group: "GENERAL",
        scope: Scope::Global,
        defaults: &["shift+left", "alt+shift+h"],
    },
    ActionSpec {
        action: Action::MovePanel(crate::layout::Side::Right),
        id: "move_panel_right",
        label: "Move panel right",
        hint: "Re-tile: the focused panel goes right of its neighbour, or onto the right edge",
        group: "GENERAL",
        scope: Scope::Global,
        defaults: &["shift+right", "alt+shift+l"],
    },
    ActionSpec {
        action: Action::MovePanel(crate::layout::Side::Above),
        id: "move_panel_up",
        label: "Move panel up",
        hint: "Re-tile: the focused panel goes above its neighbour, or onto the top edge",
        group: "GENERAL",
        scope: Scope::Global,
        defaults: &["shift+up", "alt+shift+k"],
    },
    ActionSpec {
        action: Action::MovePanel(crate::layout::Side::Below),
        id: "move_panel_down",
        label: "Move panel down",
        hint: "Re-tile: the focused panel goes below its neighbour, or onto the bottom edge",
        group: "GENERAL",
        scope: Scope::Global,
        defaults: &["shift+down", "alt+shift+j"],
    },
    ...
    ActionSpec {
        ...
        id: "hosts",
        label: "SSH hosts",
        hint: "Connect to a saved ssh host (restarts pacer over ssh)",
        group: "GENERAL",
        scope: Scope::Global,
        defaults: &["shift+h"],
    },
    ...
    ActionSpec {
        ...
        id: "metrics",
        label: "Memory usage",
        hint: "RAM used by pacer and every live agent's process tree",
        group: "GENERAL",
        scope: Scope::Global,
        defaults: &["shift+m"],
    },
...
/// How likely a chord is to actually reach pacer from inside the user's
/// terminal emulator.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum Reach {
...
/// Whether the host terminal is likely to swallow `chord` before pacer
/// sees it, and why. pacer is always a guest inside Terminal.app, Ghostty,
